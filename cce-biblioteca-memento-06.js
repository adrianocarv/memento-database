...
function generalCheck(isContactField, useSequenceCode, codeFieldName) {
  ...
  //checkUnique
  if(useSequenceCode){
    codeSequenceCheck(codeFieldName, codigosArrayLib);
  }
...
//Function
function codeSequenceCheck(codeFieldName, codigosArrayLib){
...
//Function
function setCheckCodigoInconsistence(codeFieldName, codigo, value) {
  for (var i = 0; i < entries.length; i++) {
